...
const Hero: React.FC = () => {
  return (
    <div className="bg-black text-white py-20 px-4 relative overflow-hidden flex items-center justify-center min-h-screen">
      {/* Main content */}
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        <p className="text-lg md:text-xl max-w-3xl mx-auto mb-8 text-gray-300">
          ...
          designed to improve productivity and code quality for React
          developers.
        </p>
        <div>
          <button className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-8 rounded-full inline-flex items-center transition duration-300">
            ...
            <svg
              className="w-5 h-5 ml-2 text-cyan-300"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
      ...
      <div className="absolute bottom-0 right-0 w-full h-1/2 pointer-events-none">
        <div className="w-full h-full bg-purple-600 rounded-full opacity-30 filter blur-3xl transform -translate-y-[80%] translate-x-1/4 rotate-180"></div>
      </div>
    </div>
  );
};
