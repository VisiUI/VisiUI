    ...
    <nav className="bg-black text-white py-4 px-6 font-colvetica">
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-6">
          ...
          <Link href="/contact" className="bg-[#8b5cf6] hover:bg-purple-500 text-white py-2 px-6 rounded-full inline-flex items-center transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/50">
            Contact
