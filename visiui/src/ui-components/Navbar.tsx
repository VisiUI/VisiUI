...
export default function Nav() {
  return (
    <div className="mx-4 md:mx-2 lg:mx-4">
      <Navbar isBordered variant="sticky" className={`shadow-lg h-16 bg-white text-gray-900 dark:bg-gray-900 dark:text-white`}>
        <div className="flex items-center justify-between w-full mx-2">
          ...
          <NavbarContent className="flex-shrink-0 flex items-center gap-4">
            ...
            <NavbarItem>
            <Button as={Link} color="primary" href="#" variant="flat" className="bg-blue-400 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 transition-all px-4 py-2 rounded-lg">
                Sign Up
              </Button>
            </NavbarItem>
          </NavbarContent>
